    ...
    async () => {
      ...
      if (outputPath) {
        ...
        if (options.normalizeHashes) {
          expect(normalizeGriffelHashes(resultModule)).toBe(normalizeGriffelHashes(moduleOutput));
        } else {
      ...
      if (cssOutputPath) {
        ...
        if (options.normalizeHashes) {
          expect(normalizeGriffelHashes(resultCSS)).toBe(normalizeGriffelHashes(cssOutput));
        } else {
